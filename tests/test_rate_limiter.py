...
# def test_rate_limiter_with_redis_interruption(mock_wikipedia_response, limiter_test_interruption):
#     """
...
#     print(RedisWrapper._connection)
#     response = client.get(url="http://localhost/v1/places/osm:relation:7515426?lang=es")
#     assert response.status_code == 200
