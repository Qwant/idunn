...
def test_bbox():
    ...
    response = client.get(
        url=f'http://localhost/v1/venues?left=2&bot=48&right=3&top=49&categories=bakery,museum,place_of_worship'
    )
    ...
    assert resp == [
        ...
        },
        {
            ...
            'blocks': [{'type': 'phone', 'url': 'tel:+33 1 42 72 09 37', 'international_format': '+33 1 42 72 09 37', 'local_format': '+33 1 42 72 09 37'}, {'type': 'website', 'url': 'http://www.paris.catholique.fr/-Notre-Dame-des-Blancs-Manteaux,1290-.html'}, {'type': 'contact', 'url': 'mailto:nd.blancs.manteaux@free.fr'}]
        },
        {
            'type': 'poi',
...
def test_category():
    ...
    """
    response = client.get(
        url=f'http://localhost/v1/venues?left=2&bot=48&right=3&top=49&categories=place_of_worship'
    )
