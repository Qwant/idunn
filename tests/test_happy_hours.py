...
from idunn.blocks.happy_hour import HappyHourBlock
        ...
        days=[
            {
                ...
                "status": "yes",
                "happy_hours": [{"beginning": "20:00", "end": "22:00"}],
            },
            {
                "dayofweek": 2,
...
def test_happy_hour_over():
    ...
    assert all(d.status == "yes" for d in hh_block.days)
