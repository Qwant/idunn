...
if "MIMIR_ES_URL" in os.environ:

    @pytest.fixture(scope="session")
    def mimir_es():
        url = os.getenv("MIMIR_ES_URL")
...
if "WIKI_ES_URL" in os.environ:

    @pytest.fixture(scope="session")
    def wiki_es():
        url = os.getenv("WIKI_ES_URL")
...
if "WIKI_REDIS_URL" in os.environ:

    @pytest.fixture(scope="session")
    def redis():
        return os.getenv("WIKI_REDIS_URL")
