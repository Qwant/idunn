...
def test_opening_hour():
    ...
    We freeze time at different datetimes and for each
    we create a fake OpeningHourBlock from a raw json
    extracted from a POI located in Moscow city.
    """
    ...
    with freeze_time("2018-06-14 21:30:00", tz_offset=0):
        oh_block = OpeningHourBlock.from_es(
            {
                "coord": {
                    "lon": 37.588161523500276,
